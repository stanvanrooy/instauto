...
public class SigquitDetectorAcra implements AnonymousClass02K {
    ...
    private void sigquitDetected(String str, String str2, boolean z, boolean z2) {
        AnonymousClass0DB.A0K("SigquitDetectorAcra", "sigquitDetected inFgV1: %b inFgV2: %b", Boolean.valueOf(z), Boolean.valueOf(z2));
    ...
    public void init(C021801j r18, boolean z) {
        ...
        AnonymousClass0DB.A0E("SigquitDetectorAcra", "nativeInit");
        boolean z3 = sIsArt;
    ...
    public void installSignalHandler(Handler handler, boolean z) {
        AnonymousClass0ZA.A0E(this.mMainThreadHandler, new AnonymousClass02M(this, handler, new AnonymousClass02L(this, z)), 1180122912);
    }

    public SigquitDetectorAcra(AnonymousClass02P r1) {
        this.mListener = r1;
    }
