...
public class ARTSurfaceViewManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        ...
        AnonymousClass9DG r6 = (AnonymousClass9DG) view;
        boolean z = false;
        switch (str.hashCode()) {
            case -1721943862:
                c = 18;
        ...
        switch (c) {
            case 0:
                aRTSurfaceViewManager.setAccessibilityActions(r6, (A1e) obj);
                return;
            case 1:
                aRTSurfaceViewManager.setAccessibilityHint(r6, (String) obj);
                return;
            case 2:
                aRTSurfaceViewManager.setAccessibilityLabel(r6, (String) obj);
                return;
            case 3:
                aRTSurfaceViewManager.setAccessibilityLiveRegion(r6, (String) obj);
                return;
            case 4:
                aRTSurfaceViewManager.setAccessibilityRole(r6, (String) obj);
                return;
            case 5:
                aRTSurfaceViewManager.setViewState(r6, (C23043A0y) obj);
                return;
            case 6:
                aRTSurfaceViewManager.setAccessibilityValue(r6, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, r6.getContext()).intValue();
                }
                aRTSurfaceViewManager.setBackgroundColor(r6, (int) z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                aRTSurfaceViewManager.setElevation(r6, f2);
                return;
            case 9:
                aRTSurfaceViewManager.setImportantForAccessibility(r6, (String) obj);
                return;
            case 10:
                aRTSurfaceViewManager.setNativeId(r6, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                aRTSurfaceViewManager.setOpacity(r6, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                aRTSurfaceViewManager.setRenderToHardwareTexture(r6, z);
                return;
            ...
            case 15:
                ...
                return;
            case 16:
                aRTSurfaceViewManager.setTestId(r6, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                aRTSurfaceViewManager.setTransform(r6, (A1e) obj);
                return;
            case 18:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                aRTSurfaceViewManager.setTranslateX(r6, f2);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                aRTSurfaceViewManager.setTranslateY(r6, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                aRTSurfaceViewManager.setZIndex(r6, f2);
                return;
            default:
                return;
        }
