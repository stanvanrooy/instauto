...
public class LayoutShadowNode$$PropsSetter implements ViewManagerPropertyUpdater$ShadowNodeSetter {
    ...
    public final void Bjr(ReactShadowNode reactShadowNode, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                layoutShadowNode.setAlignContent((String) obj);
                return;
            case 1:
                layoutShadowNode.setAlignItems((String) obj);
                return;
            case 2:
                layoutShadowNode.setAlignSelf((String) obj);
                return;
            case 3:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setAspectRatio(f2);
                return;
            case 4:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(4, f2);
                return;
            case 5:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(2, f2);
                return;
            case 6:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(5, f2);
                return;
            case 7:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(6, f2);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(1, f2);
                return;
            case 9:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(3, f2);
                return;
            case 10:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                layoutShadowNode.setBorderWidths(0, f2);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                layoutShadowNode.setPositionValues(5, new A1P(obj));
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                layoutShadowNode.setDisplay((String) obj);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                layoutShadowNode.setPositionValues(1, new A1P(obj));
                return;
            case 15:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                layoutShadowNode.setFlex(f);
                return;
            case 16:
                layoutShadowNode.setFlexBasis(new A1P(obj));
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                layoutShadowNode.setFlexDirection((String) obj);
                return;
            case 18:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                layoutShadowNode.setFlexGrow(f);
                return;
            case 19:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                layoutShadowNode.setFlexShrink(f);
                return;
            case 20:
                layoutShadowNode.setFlexWrap((String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BRANDING:
                layoutShadowNode.setHeight(new A1P(obj));
                return;
            case C120125Dh.NUM_VIEW_TYPES:
                layoutShadowNode.setJustifyContent((String) obj);
                return;
            case 23:
                layoutShadowNode.setPositionValues(2, new A1P(obj));
                return;
            case 24:
                layoutShadowNode.setMargins(0, new A1P(obj));
                return;
            case 25:
                layoutShadowNode.setMargins(6, new A1P(obj));
                return;
            case OdexSchemeArtXdex.OREO_SDK_INT:
                layoutShadowNode.setMargins(4, new A1P(obj));
                return;
            case 27:
                layoutShadowNode.setMargins(2, new A1P(obj));
                return;
            case 28:
                layoutShadowNode.setMargins(7, new A1P(obj));
                return;
            case CameraRollManager.IMAGES_MEDIA_LATITUDE_LONGITUDE_DEPRECATED_API_LEVEL:
                layoutShadowNode.setMargins(8, new A1P(obj));
                return;
            case 30:
                layoutShadowNode.setMargins(3, new A1P(obj));
                return;
            case 31:
                layoutShadowNode.setMargins(5, new A1P(obj));
                return;
            case ' ':
                layoutShadowNode.setMargins(1, new A1P(obj));
                return;
            case '!':
                layoutShadowNode.setMaxHeight(new A1P(obj));
                return;
            case '\"':
                layoutShadowNode.setMaxWidth(new A1P(obj));
                return;
            case '#':
                layoutShadowNode.setMinHeight(new A1P(obj));
                return;
            case '$':
                layoutShadowNode.setMinWidth(new A1P(obj));
                return;
            case '%':
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                layoutShadowNode.A08 = z;
                return;
            case '&':
                layoutShadowNode.setOverflow((String) obj);
                return;
            case '\'':
                layoutShadowNode.setPaddings(0, new A1P(obj));
                return;
            case '(':
                layoutShadowNode.setPaddings(6, new A1P(obj));
                return;
            case ')':
                layoutShadowNode.setPaddings(4, new A1P(obj));
                return;
            case '*':
                layoutShadowNode.setPaddings(2, new A1P(obj));
                return;
            case '+':
                layoutShadowNode.setPaddings(7, new A1P(obj));
                return;
            case ',':
                layoutShadowNode.setPaddings(8, new A1P(obj));
                return;
            case '-':
                layoutShadowNode.setPaddings(3, new A1P(obj));
                return;
            case '.':
                layoutShadowNode.setPaddings(5, new A1P(obj));
                return;
            case '/':
                layoutShadowNode.setPaddings(1, new A1P(obj));
                return;
            case '0':
                layoutShadowNode.setPosition((String) obj);
                return;
            case '1':
                layoutShadowNode.setPositionValues(3, new A1P(obj));
                return;
            case AMD.MAX_LIKES_PER_FETCH:
                layoutShadowNode.setPositionValues(0, new A1P(obj));
                return;
            case '3':
                layoutShadowNode.setPositionValues(4, new A1P(obj));
                return;
            case '4':
                layoutShadowNode.setWidth(new A1P(obj));
                return;
            default:
                return;
        }
