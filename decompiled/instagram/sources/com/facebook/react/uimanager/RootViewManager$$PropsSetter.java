...
public class RootViewManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                rootViewManager.setAccessibilityActions(viewGroup, (A1e) obj);
                return;
            case 1:
            ...
            case 4:
                ...
                return;
            case 5:
                rootViewManager.setViewState(viewGroup, (C23043A0y) obj);
                return;
            case 6:
                rootViewManager.setAccessibilityValue(viewGroup, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, viewGroup.getContext()).intValue();
                }
                rootViewManager.setBackgroundColor(viewGroup, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                rootViewManager.setElevation(viewGroup, f2);
                return;
            case 9:
            ...
            case C120125Dh.VIEW_TYPE_BANNER:
                ...
                rootViewManager.setOpacity(viewGroup, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                rootViewManager.setRenderToHardwareTexture(viewGroup, z);
                return;
            ...
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                rootViewManager.setTransform(viewGroup, (A1e) obj);
                return;
            case 18:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                rootViewManager.setTranslateX(viewGroup, f2);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                rootViewManager.setTranslateY(viewGroup, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                rootViewManager.setZIndex(viewGroup, f2);
                return;
            default:
                return;
        }
