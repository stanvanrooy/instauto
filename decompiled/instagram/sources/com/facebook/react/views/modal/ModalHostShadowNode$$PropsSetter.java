    ...
    public final void Bjr(ReactShadowNode reactShadowNode, String str, Object obj) {
        ...
        switch (c) {
            ...
            case 3:
                ...
                modalHostShadowNode.setAspectRatio(f2);
                return;
            case 4:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(4, f2);
                return;
            case 5:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(2, f2);
                return;
            case 6:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(5, f2);
                return;
            case 7:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(6, f2);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(1, f2);
                return;
            case 9:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(3, f2);
                return;
            case 10:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                modalHostShadowNode.setBorderWidths(0, f2);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                modalHostShadowNode.setPositionValues(5, new A1P(obj));
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                modalHostShadowNode.setDisplay((String) obj);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                modalHostShadowNode.setPositionValues(1, new A1P(obj));
                return;
            case 15:
                if (obj != null) {
                ...
                return;
            case 16:
                modalHostShadowNode.setFlexBasis(new A1P(obj));
                return;
            ...
            case C120125Dh.VIEW_TYPE_BRANDING:
                modalHostShadowNode.setHeight(new A1P(obj));
                return;
            case C120125Dh.NUM_VIEW_TYPES:
                modalHostShadowNode.setJustifyContent((String) obj);
                return;
            case 23:
                modalHostShadowNode.setPositionValues(2, new A1P(obj));
                return;
            case 24:
                modalHostShadowNode.setMargins(0, new A1P(obj));
                return;
            case 25:
                modalHostShadowNode.setMargins(6, new A1P(obj));
                return;
            case OdexSchemeArtXdex.OREO_SDK_INT:
                modalHostShadowNode.setMargins(4, new A1P(obj));
                return;
            case 27:
                modalHostShadowNode.setMargins(2, new A1P(obj));
                return;
            case 28:
                modalHostShadowNode.setMargins(7, new A1P(obj));
                return;
            case CameraRollManager.IMAGES_MEDIA_LATITUDE_LONGITUDE_DEPRECATED_API_LEVEL:
                modalHostShadowNode.setMargins(8, new A1P(obj));
                return;
            case 30:
                modalHostShadowNode.setMargins(3, new A1P(obj));
                return;
            case 31:
                modalHostShadowNode.setMargins(5, new A1P(obj));
                return;
            case ' ':
                modalHostShadowNode.setMargins(1, new A1P(obj));
                return;
            case '!':
                modalHostShadowNode.setMaxHeight(new A1P(obj));
                return;
            case '\"':
                modalHostShadowNode.setMaxWidth(new A1P(obj));
                return;
            case '#':
                modalHostShadowNode.setMinHeight(new A1P(obj));
                return;
            case '$':
                modalHostShadowNode.setMinWidth(new A1P(obj));
                return;
            case '%':
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                modalHostShadowNode.A08 = z;
                return;
            case '&':
                modalHostShadowNode.setOverflow((String) obj);
                return;
            case '\'':
                modalHostShadowNode.setPaddings(0, new A1P(obj));
                return;
            case '(':
                modalHostShadowNode.setPaddings(6, new A1P(obj));
                return;
            case ')':
                modalHostShadowNode.setPaddings(4, new A1P(obj));
                return;
            case '*':
                modalHostShadowNode.setPaddings(2, new A1P(obj));
                return;
            case '+':
                modalHostShadowNode.setPaddings(7, new A1P(obj));
                return;
            case ',':
                modalHostShadowNode.setPaddings(8, new A1P(obj));
                return;
            case '-':
                modalHostShadowNode.setPaddings(3, new A1P(obj));
                return;
            case '.':
                modalHostShadowNode.setPaddings(5, new A1P(obj));
                return;
            case '/':
                modalHostShadowNode.setPaddings(1, new A1P(obj));
                return;
            case '0':
                modalHostShadowNode.setPosition((String) obj);
                return;
            case '1':
                modalHostShadowNode.setPositionValues(3, new A1P(obj));
                return;
            case AMD.MAX_LIKES_PER_FETCH:
                modalHostShadowNode.setPositionValues(0, new A1P(obj));
                return;
            case '3':
                modalHostShadowNode.setPositionValues(4, new A1P(obj));
                return;
            case '4':
                modalHostShadowNode.setWidth(new A1P(obj));
                return;
            default:
                return;
        }
