...
public class ReactDropdownPickerManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                reactDropdownPickerManager.setAccessibilityActions(a6p, (A1e) obj);
                return;
            case 1:
                reactDropdownPickerManager.setAccessibilityHint(a6p, (String) obj);
                return;
            case 2:
                reactDropdownPickerManager.setAccessibilityLabel(a6p, (String) obj);
                return;
            case 3:
                reactDropdownPickerManager.setAccessibilityLiveRegion(a6p, (String) obj);
                return;
            case 4:
                reactDropdownPickerManager.setAccessibilityRole(a6p, (String) obj);
                return;
            case 5:
                reactDropdownPickerManager.setViewState(a6p, (C23043A0y) obj);
                return;
            case 6:
                reactDropdownPickerManager.setAccessibilityValue(a6p, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z2 = C206578th.A00(obj, a6p.getContext()).intValue();
                }
                reactDropdownPickerManager.setBackgroundColor(a6p, z2);
                return;
            case 8:
                if (obj == null) {
                    valueOf = null;
            ...
            case 9:
                ...
                reactDropdownPickerManager.setElevation(a6p, f2);
                return;
            case 10:
                if (obj != null) {
            ...
            case C120125Dh.VIEW_TYPE_BANNER:
                reactDropdownPickerManager.setImportantForAccessibility(a6p, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                reactDropdownPickerManager.setItems(a6p, (A1e) obj);
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                reactDropdownPickerManager.setNativeId(a6p, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                reactDropdownPickerManager.setOpacity(a6p, f);
                return;
            case 15:
            ...
            case 16:
                ...
                reactDropdownPickerManager.setRenderToHardwareTexture(a6p, z2);
                return;
            ...
            case C120125Dh.VIEW_TYPE_BRANDING:
                reactDropdownPickerManager.setTestId(a6p, (String) obj);
                return;
            case C120125Dh.NUM_VIEW_TYPES:
                reactDropdownPickerManager.setTransform(a6p, (A1e) obj);
                return;
            case 23:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactDropdownPickerManager.setTranslateX(a6p, f2);
                return;
            case 24:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactDropdownPickerManager.setTranslateY(a6p, f2);
                return;
            case 25:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactDropdownPickerManager.setZIndex(a6p, f2);
                return;
            default:
                return;
        }
