...
public class ProgressBarShadowNode$$PropsSetter implements ViewManagerPropertyUpdater$ShadowNodeSetter {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:107:0x0268, code lost:
        if (r14.equals(com.facebook.react.views.progressbar.ReactProgressBarViewManager.PROP_STYLE) == false) goto L_0x0013;
     */
    ...
    public final void Bjr(ReactShadowNode reactShadowNode, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                progressBarShadowNode.setAlignContent((String) obj);
                return;
            case 1:
                progressBarShadowNode.setAlignItems((String) obj);
                return;
            case 2:
                progressBarShadowNode.setAlignSelf((String) obj);
                return;
            case 3:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setAspectRatio(f2);
                return;
            case 4:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(4, f2);
                return;
            case 5:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(2, f2);
                return;
            case 6:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(5, f2);
                return;
            case 7:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(6, f2);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(1, f2);
                return;
            case 9:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(3, f2);
                return;
            case 10:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setBorderWidths(0, f2);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                progressBarShadowNode.setPositionValues(5, new A1P(obj));
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                progressBarShadowNode.setDisplay((String) obj);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                progressBarShadowNode.setPositionValues(1, new A1P(obj));
                return;
            case 15:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setFlex(f);
                return;
            case 16:
                progressBarShadowNode.setFlexBasis(new A1P(obj));
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                progressBarShadowNode.setFlexDirection((String) obj);
                return;
            case 18:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setFlexGrow(f);
                return;
            case 19:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                progressBarShadowNode.setFlexShrink(f);
                return;
            case 20:
                progressBarShadowNode.setFlexWrap((String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BRANDING:
                progressBarShadowNode.setHeight(new A1P(obj));
                return;
            case C120125Dh.NUM_VIEW_TYPES:
                progressBarShadowNode.setJustifyContent((String) obj);
                return;
            case 23:
                progressBarShadowNode.setPositionValues(2, new A1P(obj));
                return;
            case 24:
                progressBarShadowNode.setMargins(0, new A1P(obj));
                return;
            case 25:
                progressBarShadowNode.setMargins(6, new A1P(obj));
                return;
            case OdexSchemeArtXdex.OREO_SDK_INT:
                progressBarShadowNode.setMargins(4, new A1P(obj));
                return;
            case 27:
                progressBarShadowNode.setMargins(2, new A1P(obj));
                return;
            case 28:
                progressBarShadowNode.setMargins(7, new A1P(obj));
                return;
            case CameraRollManager.IMAGES_MEDIA_LATITUDE_LONGITUDE_DEPRECATED_API_LEVEL:
                progressBarShadowNode.setMargins(8, new A1P(obj));
                return;
            case 30:
                progressBarShadowNode.setMargins(3, new A1P(obj));
                return;
            case 31:
                progressBarShadowNode.setMargins(5, new A1P(obj));
                return;
            case ' ':
                progressBarShadowNode.setMargins(1, new A1P(obj));
                return;
            case '!':
                progressBarShadowNode.setMaxHeight(new A1P(obj));
                return;
            case '\"':
                progressBarShadowNode.setMaxWidth(new A1P(obj));
                return;
            case '#':
                progressBarShadowNode.setMinHeight(new A1P(obj));
                return;
            case '$':
                progressBarShadowNode.setMinWidth(new A1P(obj));
                return;
            case '%':
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                progressBarShadowNode.A08 = z;
                return;
            case '&':
                progressBarShadowNode.setOverflow((String) obj);
                return;
            case '\'':
                progressBarShadowNode.setPaddings(0, new A1P(obj));
                return;
            case '(':
                progressBarShadowNode.setPaddings(6, new A1P(obj));
                return;
            case ')':
                progressBarShadowNode.setPaddings(4, new A1P(obj));
                return;
            case '*':
                progressBarShadowNode.setPaddings(2, new A1P(obj));
                return;
            case '+':
                progressBarShadowNode.setPaddings(7, new A1P(obj));
                return;
            case ',':
                progressBarShadowNode.setPaddings(8, new A1P(obj));
                return;
            case '-':
                progressBarShadowNode.setPaddings(3, new A1P(obj));
                return;
            case '.':
                progressBarShadowNode.setPaddings(5, new A1P(obj));
                return;
            case '/':
                progressBarShadowNode.setPaddings(1, new A1P(obj));
                return;
            case '0':
                progressBarShadowNode.setPosition((String) obj);
                return;
            case '1':
                progressBarShadowNode.setPositionValues(3, new A1P(obj));
                return;
            case AMD.MAX_LIKES_PER_FETCH:
                progressBarShadowNode.setPositionValues(0, new A1P(obj));
                return;
            case '3':
                progressBarShadowNode.setStyle((String) obj);
                return;
            case '4':
                progressBarShadowNode.setPositionValues(4, new A1P(obj));
                return;
            case '5':
                progressBarShadowNode.setWidth(new A1P(obj));
                return;
            default:
                return;
        }
