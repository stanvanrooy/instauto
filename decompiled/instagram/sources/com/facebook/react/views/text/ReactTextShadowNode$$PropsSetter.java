...
public class ReactTextShadowNode$$PropsSetter implements ViewManagerPropertyUpdater$ShadowNodeSetter {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:101:0x024f, code lost:
        if (r13.equals("onTextLayout") == false) goto L_0x001a;
     */
    ...
    public final void Bjr(ReactShadowNode reactShadowNode, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                ...
                return;
            case 1:
                reactTextShadowNode.setAlignContent((String) obj2);
                return;
            case 2:
                reactTextShadowNode.setAlignItems((String) obj2);
                return;
            case 3:
                reactTextShadowNode.setAlignSelf((String) obj2);
                return;
            case 4:
                if (obj != null) {
            ...
            case 5:
                ...
                reactTextShadowNode.setAspectRatio(f2);
                return;
            case 6:
                if (obj != null) {
                    num = Integer.valueOf(C206578th.A00(obj2, reactTextShadowNode.AY1()).intValue());
                }
                reactTextShadowNode.setBackgroundColor(num);
                return;
            case 7:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(4, f2);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(2, f2);
                return;
            case 9:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(5, f2);
                return;
            case 10:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(6, f2);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(1, f2);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(3, f2);
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setBorderWidths(0, f2);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                reactTextShadowNode.setPositionValues(5, new A1P(obj2));
                return;
            case 16:
                if (obj != null) {
                    num = Integer.valueOf(C206578th.A00(obj2, reactTextShadowNode.AY1()).intValue());
                }
                reactTextShadowNode.setColor(num);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                reactTextShadowNode.setDisplay((String) obj2);
                return;
            case 18:
                reactTextShadowNode.setPositionValues(1, new A1P(obj2));
                return;
            case 19:
                if (obj != null) {
                    f = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setFlex(f);
                return;
            case 20:
                reactTextShadowNode.setFlexBasis(new A1P(obj2));
                return;
            case C120125Dh.VIEW_TYPE_BRANDING:
                reactTextShadowNode.setFlexDirection((String) obj2);
                return;
            case C120125Dh.NUM_VIEW_TYPES:
                if (obj != null) {
                    f = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setFlexGrow(f);
                return;
            case 23:
                if (obj != null) {
                    f = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setFlexShrink(f);
                return;
            case 24:
                reactTextShadowNode.setFlexWrap((String) obj2);
                return;
            case 25:
                reactTextShadowNode.setFontFamily((String) obj2);
                return;
            case OdexSchemeArtXdex.OREO_SDK_INT:
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setFontSize(f2);
                return;
            case 27:
                reactTextShadowNode.setFontStyle((String) obj2);
                return;
            case 28:
                reactTextShadowNode.setFontVariant((A1e) obj2);
                return;
            case CameraRollManager.IMAGES_MEDIA_LATITUDE_LONGITUDE_DEPRECATED_API_LEVEL:
                reactTextShadowNode.setFontWeight((String) obj2);
                return;
            case 30:
                reactTextShadowNode.setHeight(new A1P(obj2));
                return;
            case 31:
                if (obj != null) {
                    z = ((Boolean) obj2).booleanValue();
                }
                reactTextShadowNode.setIncludeFontPadding(z);
                return;
            case ' ':
                reactTextShadowNode.setJustifyContent((String) obj2);
                return;
            case '!':
                reactTextShadowNode.setPositionValues(2, new A1P(obj2));
                return;
            case '\"':
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setLetterSpacing(f2);
                return;
            case '#':
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setLineHeight(f2);
                return;
            case '$':
                reactTextShadowNode.setMargins(0, new A1P(obj2));
                return;
            case '%':
                reactTextShadowNode.setMargins(6, new A1P(obj2));
                return;
            case '&':
                reactTextShadowNode.setMargins(4, new A1P(obj2));
                return;
            case '\'':
                reactTextShadowNode.setMargins(2, new A1P(obj2));
                return;
            case '(':
                reactTextShadowNode.setMargins(7, new A1P(obj2));
                return;
            case ')':
                reactTextShadowNode.setMargins(8, new A1P(obj2));
                return;
            case '*':
                reactTextShadowNode.setMargins(3, new A1P(obj2));
                return;
            case '+':
                reactTextShadowNode.setMargins(5, new A1P(obj2));
                return;
            case ',':
                reactTextShadowNode.setMargins(1, new A1P(obj2));
                return;
            case '-':
                if (obj != null) {
                    f2 = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setMaxFontSizeMultiplier(f2);
                return;
            case '.':
                reactTextShadowNode.setMaxHeight(new A1P(obj2));
                return;
            case '/':
                reactTextShadowNode.setMaxWidth(new A1P(obj2));
                return;
            case '0':
                reactTextShadowNode.setMinHeight(new A1P(obj2));
                return;
            case '1':
                reactTextShadowNode.setMinWidth(new A1P(obj2));
                return;
            case AMD.MAX_LIKES_PER_FETCH:
                if (obj != null) {
                    f = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setMinimumFontScale(f);
                return;
            case '3':
                if (obj != null) {
            ...
            case '4':
                ...
                reactTextShadowNode.A08 = z2;
                return;
            case '5':
                if (obj != null) {
                    z2 = ((Boolean) obj2).booleanValue();
                }
                reactTextShadowNode.setShouldNotifyOnTextLayout(z2);
                return;
            case '6':
                reactTextShadowNode.setOverflow((String) obj2);
                return;
            case '7':
                reactTextShadowNode.setPaddings(0, new A1P(obj2));
                return;
            case '8':
                reactTextShadowNode.setPaddings(6, new A1P(obj2));
                return;
            case '9':
                reactTextShadowNode.setPaddings(4, new A1P(obj2));
                return;
            case ':':
                reactTextShadowNode.setPaddings(2, new A1P(obj2));
                return;
            case ';':
                reactTextShadowNode.setPaddings(7, new A1P(obj2));
                return;
            case '<':
                reactTextShadowNode.setPaddings(8, new A1P(obj2));
                return;
            case '=':
                reactTextShadowNode.setPaddings(3, new A1P(obj2));
                return;
            case '>':
                reactTextShadowNode.setPaddings(5, new A1P(obj2));
                return;
            case '?':
                reactTextShadowNode.setPaddings(1, new A1P(obj2));
                return;
            case '@':
                reactTextShadowNode.setPosition((String) obj2);
                return;
            case 'A':
                reactTextShadowNode.setPositionValues(3, new A1P(obj2));
                return;
            case 'B':
                reactTextShadowNode.setPositionValues(0, new A1P(obj2));
                return;
            case 'C':
                reactTextShadowNode.setTextAlign((String) obj2);
                return;
            case 'D':
                reactTextShadowNode.setTextBreakStrategy((String) obj2);
                return;
            case 'E':
                reactTextShadowNode.setTextDecorationLine((String) obj2);
                return;
            case 'F':
                if (obj == null) {
                    intValue = 1426063360;
                } else {
                    intValue = C206578th.A00(obj2, reactTextShadowNode.AY1()).intValue();
                }
                reactTextShadowNode.setTextShadowColor(intValue);
                return;
            case 'G':
                reactTextShadowNode.setTextShadowOffset((C23043A0y) obj2);
                return;
            case 'H':
                if (obj != null) {
                    f = ((Double) obj2).floatValue();
                }
                reactTextShadowNode.setTextShadowRadius(f);
                return;
            case 'I':
                reactTextShadowNode.setTextTransform((String) obj2);
                return;
            case 'J':
                reactTextShadowNode.setPositionValues(4, new A1P(obj2));
                return;
            case 'K':
                reactTextShadowNode.setWidth(new A1P(obj2));
                return;
            default:
                return;
        }
