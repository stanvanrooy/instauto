...
public class IgReactPerformanceLoggerFlagManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        char c;
        IgReactPerformanceLoggerFlagManager igReactPerformanceLoggerFlagManager = (IgReactPerformanceLoggerFlagManager) viewManager;
        A2B a2b = (A2B) view;
        boolean z = false;
        switch (str.hashCode()) {
            case -1721943862:
        ...
        switch (c) {
            case 0:
                igReactPerformanceLoggerFlagManager.setAccessibilityActions(a2b, (A1e) obj);
                return;
            case 1:
                igReactPerformanceLoggerFlagManager.setAccessibilityHint(a2b, (String) obj);
                return;
            case 2:
                igReactPerformanceLoggerFlagManager.setAccessibilityLabel(a2b, (String) obj);
                return;
            case 3:
                igReactPerformanceLoggerFlagManager.setAccessibilityLiveRegion(a2b, (String) obj);
                return;
            case 4:
                igReactPerformanceLoggerFlagManager.setAccessibilityRole(a2b, (String) obj);
                return;
            case 5:
                igReactPerformanceLoggerFlagManager.setViewState(a2b, (C23043A0y) obj);
                return;
            case 6:
                igReactPerformanceLoggerFlagManager.setAccessibilityValue(a2b, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, a2b.getContext()).intValue();
                }
                igReactPerformanceLoggerFlagManager.setBackgroundColor(a2b, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igReactPerformanceLoggerFlagManager.setElevation(a2b, f2);
                return;
            case 9:
                igReactPerformanceLoggerFlagManager.setImportantForAccessibility(a2b, (String) obj);
                return;
            case 10:
                igReactPerformanceLoggerFlagManager.setNativeId(a2b, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                igReactPerformanceLoggerFlagManager.setOpacity(a2b, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                igReactPerformanceLoggerFlagManager.setRenderToHardwareTexture(a2b, z);
                return;
            ...
            case 15:
                ...
                return;
            case 16:
                igReactPerformanceLoggerFlagManager.setTestId(a2b, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                igReactPerformanceLoggerFlagManager.setTransform(a2b, (A1e) obj);
                return;
            case 18:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igReactPerformanceLoggerFlagManager.setTranslateX(a2b, f2);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igReactPerformanceLoggerFlagManager.setTranslateY(a2b, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igReactPerformanceLoggerFlagManager.setZIndex(a2b, f2);
                return;
            default:
                return;
        }
