...
public class ReactBubbleSpinnerManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        char c;
        ReactBubbleSpinnerManager reactBubbleSpinnerManager = (ReactBubbleSpinnerManager) viewManager;
        ...
        switch (c) {
            case 0:
                reactBubbleSpinnerManager.setAccessibilityActions(bubbleSpinner, (A1e) obj);
                return;
            case 1:
                reactBubbleSpinnerManager.setAccessibilityHint(bubbleSpinner, (String) obj);
                return;
            case 2:
                reactBubbleSpinnerManager.setAccessibilityLabel(bubbleSpinner, (String) obj);
                return;
            case 3:
                reactBubbleSpinnerManager.setAccessibilityLiveRegion(bubbleSpinner, (String) obj);
                return;
            case 4:
                reactBubbleSpinnerManager.setAccessibilityRole(bubbleSpinner, (String) obj);
                return;
            case 5:
                reactBubbleSpinnerManager.setViewState(bubbleSpinner, (C23043A0y) obj);
                return;
            case 6:
                reactBubbleSpinnerManager.setAccessibilityValue(bubbleSpinner, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, bubbleSpinner.getContext()).intValue();
                }
                reactBubbleSpinnerManager.setBackgroundColor(bubbleSpinner, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactBubbleSpinnerManager.setElevation(bubbleSpinner, f2);
                return;
            case 9:
                reactBubbleSpinnerManager.setImportantForAccessibility(bubbleSpinner, (String) obj);
                return;
            case 10:
                reactBubbleSpinnerManager.setNativeId(bubbleSpinner, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                reactBubbleSpinnerManager.setOpacity(bubbleSpinner, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                reactBubbleSpinnerManager.setRenderToHardwareTexture(bubbleSpinner, z);
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                bubbleSpinner.setRotation(f2);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                bubbleSpinner.setScaleX(f);
                return;
            case 15:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                bubbleSpinner.setScaleY(f);
                return;
            case 16:
                reactBubbleSpinnerManager.setTestId(bubbleSpinner, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                reactBubbleSpinnerManager.setTransform(bubbleSpinner, (A1e) obj);
                return;
            case 18:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactBubbleSpinnerManager.setTranslateX(bubbleSpinner, f2);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactBubbleSpinnerManager.setTranslateY(bubbleSpinner, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactBubbleSpinnerManager.setZIndex(bubbleSpinner, f2);
                return;
            default:
                return;
        }
