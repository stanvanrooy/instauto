...
public class ReactCheckmarkManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        ...
        AnonymousClass2Z4 r6 = (AnonymousClass2Z4) view;
        boolean z = false;
        switch (str.hashCode()) {
            case -1721943862:
                c = 18;
        ...
        switch (c) {
            case 0:
                reactCheckmarkManager.setAccessibilityActions(r6, (A1e) obj);
                return;
            case 1:
                reactCheckmarkManager.setAccessibilityHint(r6, (String) obj);
                return;
            case 2:
                reactCheckmarkManager.setAccessibilityLabel(r6, (String) obj);
                return;
            case 3:
                reactCheckmarkManager.setAccessibilityLiveRegion(r6, (String) obj);
                return;
            case 4:
                reactCheckmarkManager.setAccessibilityRole(r6, (String) obj);
                return;
            case 5:
                reactCheckmarkManager.setViewState(r6, (C23043A0y) obj);
                return;
            case 6:
                reactCheckmarkManager.setAccessibilityValue(r6, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, r6.getContext()).intValue();
                }
                reactCheckmarkManager.setBackgroundColor(r6, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactCheckmarkManager.setElevation(r6, f2);
                return;
            case 9:
                reactCheckmarkManager.setImportantForAccessibility(r6, (String) obj);
                return;
            case 10:
                reactCheckmarkManager.setNativeId(r6, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                reactCheckmarkManager.setOpacity(r6, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                reactCheckmarkManager.setRenderToHardwareTexture(r6, z);
                return;
            ...
            case 15:
                ...
                return;
            case 16:
                reactCheckmarkManager.setTestId(r6, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                reactCheckmarkManager.setTransform(r6, (A1e) obj);
                return;
            case 18:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactCheckmarkManager.setTranslateX(r6, f2);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactCheckmarkManager.setTranslateY(r6, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactCheckmarkManager.setZIndex(r6, f2);
                return;
            default:
                return;
        }
