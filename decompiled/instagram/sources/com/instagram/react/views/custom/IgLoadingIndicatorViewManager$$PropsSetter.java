...
public class IgLoadingIndicatorViewManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        char c;
        IgLoadingIndicatorViewManager igLoadingIndicatorViewManager = (IgLoadingIndicatorViewManager) viewManager;
        ...
        switch (c) {
            case 0:
                igLoadingIndicatorViewManager.setAccessibilityActions(spinnerImageView, (A1e) obj);
                return;
            case 1:
                igLoadingIndicatorViewManager.setAccessibilityHint(spinnerImageView, (String) obj);
                return;
            case 2:
                igLoadingIndicatorViewManager.setAccessibilityLabel(spinnerImageView, (String) obj);
                return;
            case 3:
                igLoadingIndicatorViewManager.setAccessibilityLiveRegion(spinnerImageView, (String) obj);
                return;
            case 4:
                igLoadingIndicatorViewManager.setAccessibilityRole(spinnerImageView, (String) obj);
                return;
            case 5:
                igLoadingIndicatorViewManager.setViewState(spinnerImageView, (C23043A0y) obj);
                return;
            case 6:
                igLoadingIndicatorViewManager.setAccessibilityValue(spinnerImageView, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, spinnerImageView.getContext()).intValue();
                }
                igLoadingIndicatorViewManager.setBackgroundColor(spinnerImageView, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igLoadingIndicatorViewManager.setElevation(spinnerImageView, f2);
                return;
            case 9:
                igLoadingIndicatorViewManager.setImportantForAccessibility(spinnerImageView, (String) obj);
                return;
            case 10:
                igLoadingIndicatorViewManager.setNativeId(spinnerImageView, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                igLoadingIndicatorViewManager.setOpacity(spinnerImageView, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                igLoadingIndicatorViewManager.setRenderToHardwareTexture(spinnerImageView, z);
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                spinnerImageView.setRotation(f2);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                spinnerImageView.setScaleX(f);
                return;
            case 15:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                spinnerImageView.setScaleY(f);
                return;
            case 16:
                igLoadingIndicatorViewManager.setTestId(spinnerImageView, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                igLoadingIndicatorViewManager.setTransform(spinnerImageView, (A1e) obj);
                return;
            case 18:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igLoadingIndicatorViewManager.setTranslateX(spinnerImageView, f2);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igLoadingIndicatorViewManager.setTranslateY(spinnerImageView, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igLoadingIndicatorViewManager.setZIndex(spinnerImageView, f2);
                return;
            default:
                return;
        }
