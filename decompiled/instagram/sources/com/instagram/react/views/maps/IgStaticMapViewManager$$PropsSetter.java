...
public class IgStaticMapViewManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x003d, code lost:
        if (r7.equals("region") == false) goto L_0x000c;
     */
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                igStaticMapViewManager.setAccessibilityActions(igStaticMapView, (A1e) obj);
                return;
            case 1:
                igStaticMapViewManager.setAccessibilityHint(igStaticMapView, (String) obj);
                return;
            case 2:
                igStaticMapViewManager.setAccessibilityLabel(igStaticMapView, (String) obj);
                return;
            case 3:
                igStaticMapViewManager.setAccessibilityLiveRegion(igStaticMapView, (String) obj);
                return;
            case 4:
                igStaticMapViewManager.setAccessibilityRole(igStaticMapView, (String) obj);
                return;
            case 5:
                igStaticMapViewManager.setViewState(igStaticMapView, (C23043A0y) obj);
                return;
            case 6:
                igStaticMapViewManager.setAccessibilityValue(igStaticMapView, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, igStaticMapView.getContext()).intValue();
                }
                igStaticMapViewManager.setBackgroundColor(igStaticMapView, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igStaticMapViewManager.setElevation(igStaticMapView, f2);
                return;
            case 9:
                igStaticMapViewManager.setImportantForAccessibility(igStaticMapView, (String) obj);
                return;
            case 10:
                igStaticMapViewManager.setNativeId(igStaticMapView, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                igStaticMapViewManager.setOpacity(igStaticMapView, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                igStaticMapViewManager.setRegion(igStaticMapView, (C23043A0y) obj);
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                igStaticMapViewManager.setRenderToHardwareTexture(igStaticMapView, z);
                return;
            case C120125Dh.VIEW_TYPE_LINK:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igStaticMapView.setRotation(f2);
                return;
            case 15:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                igStaticMapView.setScaleX(f);
                return;
            case 16:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                igStaticMapView.setScaleY(f);
                return;
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                igStaticMapViewManager.setTestId(igStaticMapView, (String) obj);
                return;
            case 18:
                igStaticMapViewManager.setTransform(igStaticMapView, (A1e) obj);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igStaticMapViewManager.setTranslateX(igStaticMapView, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igStaticMapViewManager.setTranslateY(igStaticMapView, f2);
                return;
            case C120125Dh.VIEW_TYPE_BRANDING:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                igStaticMapViewManager.setZIndex(igStaticMapView, f2);
                return;
            default:
                return;
        }
