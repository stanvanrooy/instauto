...
public class ReactProductCardViewManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bjs(ViewManager viewManager, View view, String str, Object obj) {
        ...
        switch (c) {
            case 0:
                reactProductCardViewManager.setAccessibilityActions(r6, (A1e) obj);
                return;
            case 1:
                reactProductCardViewManager.setAccessibilityHint(r6, (String) obj);
                return;
            case 2:
                reactProductCardViewManager.setAccessibilityLabel(r6, (String) obj);
                return;
            case 3:
                reactProductCardViewManager.setAccessibilityLiveRegion(r6, (String) obj);
                return;
            case 4:
                reactProductCardViewManager.setAccessibilityRole(r6, (String) obj);
                return;
            case 5:
                reactProductCardViewManager.setViewState(r6, (C23043A0y) obj);
                return;
            case 6:
                reactProductCardViewManager.setAccessibilityValue(r6, (C23043A0y) obj);
                return;
            case 7:
                if (obj != null) {
                    z = C206578th.A00(obj, r6.getContext()).intValue();
                }
                reactProductCardViewManager.setBackgroundColor(r6, z);
                return;
            case 8:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactProductCardViewManager.setElevation(r6, f2);
                return;
            case 9:
                reactProductCardViewManager.setImportantForAccessibility(r6, (String) obj);
                return;
            case 10:
                reactProductCardViewManager.setNativeId(r6, (String) obj);
                return;
            case C120125Dh.VIEW_TYPE_BANNER:
                if (obj != null) {
                    f = ((Double) obj).floatValue();
                }
                reactProductCardViewManager.setOpacity(r6, f);
                return;
            case C120125Dh.VIEW_TYPE_SPINNER:
                if (obj != null) {
                    z = ((Boolean) obj).booleanValue();
                }
                reactProductCardViewManager.setRenderToHardwareTexture(r6, z);
                return;
            case C120125Dh.VIEW_TYPE_BADGE:
                reactProductCardViewManager.setResizeMode(r6, (String) obj);
                return;
            ...
            case C120125Dh.VIEW_TYPE_CUSTOM_ITEM:
                reactProductCardViewManager.setTestId(r6, (String) obj);
                return;
            case 18:
                reactProductCardViewManager.setTransform(r6, (A1e) obj);
                return;
            case 19:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactProductCardViewManager.setTranslateX(r6, f2);
                return;
            case 20:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactProductCardViewManager.setTranslateY(r6, f2);
                return;
            case C120125Dh.VIEW_TYPE_BRANDING:
                if (obj != null) {
                    f2 = ((Double) obj).floatValue();
                }
                reactProductCardViewManager.setZIndex(r6, f2);
                return;
            default:
                return;
        }
